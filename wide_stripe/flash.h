...
int  find_superblock_for_pre_read(struct ssd_info *ssd,unsigned int channel,unsigned int chip,unsigned int die,unsigned int plane);
int  find_superblock_for_write(struct ssd_info *ssd,unsigned int channel,unsigned int chip,unsigned int die,unsigned int plane, struct request *req);
/***/
...
int go_one_step_interleave_twoplane(struct ssd_info* ssd, struct sub_request* sub1, struct sub_request* sub2, struct sub_request* sub3, struct sub_request* sub4, unsigned int aim_state);
